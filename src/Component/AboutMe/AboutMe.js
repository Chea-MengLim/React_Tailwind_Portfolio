    ...
    return (
        <div className="pt-28 px-5 mb-5 ">
            ...
            <div className="lg:pl-40 ">
                ...
                <h3 className="font-Preahvihear font-bold text-3xl md:text-4xl">I'm MengLim Chea</h3>
                <h3 className="font-Preahvihear font-bold text-3xl pb-4">Web Developer</h3>
                ...
                <p className=" font-Preahvihear pr-2 pt-4 border-r-blue-200">I'm learning Computer Science at Royal University of Phnom Penh. 
                ...
                <h1 className="mt-3 font-Ubuntu underline text-xl"> Why I study Computer Science ? </h1>
                <p className="font-Preahvihear">The most important aspect of computer science is problem solving, an essential skill
               ...
               <div className="mt-5 mb-5 font-Exo font-bold  items-center gap-2 border-[2px] border-yellow-400 inline-block px-3 py-2 rounded-xl hover:bg-blue-400 ease-in-out duration-500 ">
                ...
                <div className="flex ">
                    <p className="font-Ubuntu mt-3 text-red-500"> Follow me: </p>
