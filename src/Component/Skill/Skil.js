const Skill = () => {
    return (
        <div className="mt-24 px-3  ">
            <h1 className="mb-5  text-green-500 text-[40px]">Skills</h1>
            <h1> There are several techologies which I have worked with ! </h1>
            <div className='mx-auto w-[330px] sm:w-full grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 lg:gap-6 text-center py-8'>
